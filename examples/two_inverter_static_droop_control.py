...
if __name__ == '__main__':
    ...
    env = gym.make('openmodelica_microgrid_gym:ModelicaEnv_test-v1',
                   ...
                   viz_cols=['master.inst*', 'slave.inst*', 'lcl1.*', 'lc1.*', 'slave.freq','l12.*'],
                   ...
                   model_params={'rl1.resistor1.R': partial(load_step,gain=20),
                                 ...
                                 'rl1.inductor1.L': partial(load_step,gain=0.001),
                                 'rl1.inductor2.L': partial(load_step,gain=0.001),
                                 'rl1.inductor3.L': partial(load_step,gain=0.001)
                                 },
                   model_path='../fmu/grid.microgrid.fmu',
